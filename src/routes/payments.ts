...
router.get('/get_transaction', requireJwt, (_req, res) => res.status(501).json({ message: 'Not implemented' }));
router.post('/mpesa/callbackurl', (_req, res) => res.status(501).json({ message: 'Not implemented' }));
router.post('/initiate-trial', requireJwt, (_req, res) => res.status(501).json({ message: 'Not implemented' }));
router.post('/cancel-trial', requireJwt, (_req, res) => res.status(501).json({ message: 'Not implemented' }));
